...
const resources = [
  {
    ...
    category: 'Guide',
    type: 'PDF',
    description: 'Un atelier de marche et de partage pour vous accompagner dans votre parcours post-partum',
    image: image2,
    icon: FileText,
  ...
  },
  {
    ...
    category: 'Audio',
    type: 'MP3',
    description: 'Séances de méditation et de relaxation guidées pour retrouver votre paix intérieure',
    image: image3,
    icon: Headphones,
  ...
  },
  {
    ...
    category: 'Vidéo',
    type: 'VIDEO',
    description: 'Un accompagnement complet pour vivre sereinement votre premier mois avec bébé',
    image: image4,
    icon: Video,
  ...
  },
  {
    ...
    category: 'Guide',
    type: 'PDF',
    description: 'Une sélection d\'objets et de ressources pour prendre soin de vous après l\'accouchement',
    image: image6,
    icon: FileText,
    color: 'bg-chart-1/10 text-chart-1',
